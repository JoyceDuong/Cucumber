...
@Sceranio01 
Scenario:
Clicking the Pricing link from the Header menu navigates user to the Pricing page 
...
@Sceranio02 
Scenario Outline:
Correct corporate secretary details should display after updating accounting progress line 
	Given I went to the Sleek SG Home page 
	When I click on the Pricing link 
